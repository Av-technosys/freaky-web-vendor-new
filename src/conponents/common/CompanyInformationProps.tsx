...
interface CompanyInformationProps {
    data: Pick<CompanyData, 'businessName' | 'website' | 'dbaName' | 'legalEntityName' | 'einNumber' | 'businessType' | 'incorporationDate'>;
            ...
            <div className="flex flex-col  gap-6">
                    ...
                    <div className="col-span-1 flex flex-col items-start justify-center gap-3">
                        ...
                        <InputGroup>
                            ...
                            <InputGroupInput
                                ...
                                onChange={(e) => onUpdate('website', `https://${e.target.value}`)}
                            />
                        </InputGroup>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    ...
                    <div className="col-span-1 flex flex-col items-start justify-center gap-3">
                        ...
                        <Select onValueChange={(value) => onUpdate('businessType', value)} value={data.businessType}>
                        ...
                        <Popover open={open} onOpenChange={setOpen}>
                            <PopoverTrigger asChild>
                                <Button variant="outline" className="w-full justify-between font-normal">
                                    {data.incorporationDate ? data.incorporationDate.toLocaleDateString() : "Select Date"}
                                    <ChevronDownIcon />
                                </Button>
                            </PopoverTrigger>
