                    ...
                    <div className="flex flex-col gap-6 mt-3">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div className="flex flex-col gap-3">
                                ...
                                <Input
                                    ...
                                    onChange={(e) => onUpdateOwner(index, 'firstName', e.target.value)}
                            ...
                            <div className="flex flex-col gap-3">
                                ...
                                <Input
                                    ...
                                    onChange={(e) => onUpdateOwner(index, 'lastName', e.target.value)}
                        ...
                        <div className="flex flex-col gap-6 mt-3">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                <div className="flex flex-col gap-3">
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) => onUpdateOwner(index, 'address1', e.target.value)}
                                ...
                                <div className="flex flex-col gap-3">
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) => onUpdateOwner(index, 'address2', e.target.value)}
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                <div className="flex flex-col gap-3">
                                    ...
                                    <Input
                                        value={owner.country}
                                        onChange={(e) => onUpdateOwner(index, 'country', e.target.value)}
                                ...
                                <div className="flex flex-col gap-3">
                                    ...
                                    <Input
                                        value={owner.state}
                                        onChange={(e) => onUpdateOwner(index, 'state', e.target.value)}
                                ...
                                <div className="flex flex-col gap-3">
                                    ...
                                    <Input
                                        value={owner.city}
                                        onChange={(e) => onUpdateOwner(index, 'city', e.target.value)}
                                ...
                                <div className="flex flex-col gap-3">
                                    ...
                                    <Input
                                        type="number"
                                        value={owner.zipCode}
                                        onChange={(e) => onUpdateOwner(index, 'zipCode', e.target.value)}
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            <Input
                                ...
                                onChange={(e) => onUpdateOwner(index, 'percentage', e.target.value)}
                                min={25}
                                placeholder="Min 25%"
                                required
                            />
                        ...
                        <div className="flex items-center gap-6 mt-4 pt-4 border-t border-gray-200">
                            <Label className="font-bold text-base">Authorized Signatory</Label>
                            <Switch
